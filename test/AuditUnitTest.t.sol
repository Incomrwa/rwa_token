...
contract AuditUnitTest is Test {
    ...
    function Deploy(uint64 startTimestamp, uint64 cliffDuration, uint64 totalDuration, uint256 amount) public {
        ...
        // Direct deployment of Token without proxy
    ...
    function test_cliffIsZero() public {
        ...
        assertEq(vesting.vestedAmount(address(token), (uint64(block.timestamp) + totalDuration + 1 days)), amount);
    ...
    function testMaxDuration() public {
        ...
        vesting = new Vesting(beneficiary, startTime, totalDuration, cliffDuration);
    }
}
